...
def wordUsage(string):
    ...
    filteredWords = filter(lambda word: len(re.sub(r'[ ]', '', word)) > 0, splitWords)
    # iterates through all words and adds them as lower cased words to word dictionary
