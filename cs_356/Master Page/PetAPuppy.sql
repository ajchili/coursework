...
INSERT INTO Tickets (title, description, currentState, dateCreated, dateUpdated, submitter)
VALUES ('Test Ticket', 'Testing the ticket system', 1, GETDATE(), GETDATE(), 'kirinpatel@gmail.com');
INSERT INTO Tickets (title, description, currentState, dateCreated, dateUpdated, dateResolved, submitter)
VALUES ('Loss of hand', 'Petting puppies causes my hands to explode????', -1, GETDATE(), GETDATE(), GETDATE(), 'dumbo@dummy.com');
INSERT INTO Tickets (title, currentState, dateCreated, dateUpdated, submitter)
VALUES ('Test Ticket 2', 1, GETDATE(), GETDATE(), 'kirinpatel@gmail.com');
INSERT INTO Tickets (title, description, currentState, dateCreated, dateUpdated, submitter)
VALUES ('Test Ticket 3', 'Testing the ticket system', 2, GETDATE(), GETDATE(), 'kirinpatel@gmail.com');
INSERT INTO Tickets (title, description, currentState, dateCreated, dateUpdated, submitter)
VALUES ('Test Ticket 4', 'Testing the ticket system', 3, GETDATE(), GETDATE(), 'kirinpatel@gmail.com');
