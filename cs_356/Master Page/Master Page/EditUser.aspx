<%@ Page Title="" Language="C#" MasterPageFile="~/PetAPuppy.Master" AutoEventWireup="true" CodeBehind="EditUser.aspx.cs" Inherits="Master_Page.EditUser" %>
...
<asp:Content ContentPlaceHolderID="main" runat="server">
    <div class="bg-light">
        <div class="container">
			...
			<div class="form-group">
                <label for="main_txtFirstName">First Name</label>
				<asp:TextBox id="txtFirstName" runat="server" type="text" class="form-control" placeholder="First Name" MaxLength="50"></asp:TextBox>
			</div>
			<div class="form-group">
                <label for="main_txtLastName">Last Name</label>
				<asp:TextBox id="txtLastName" runat="server" type="text" class="form-control" placeholder="Last Name" MaxLength="50"></asp:TextBox>
			</div>
			<div class="form-group">
                <label for="main_txtEmail">Email Address</label>
				<asp:TextBox id="txtEmail" runat="server" type="email" class="form-control" placeholder="Email Address" MaxLength="255"></asp:TextBox>
			</div>
