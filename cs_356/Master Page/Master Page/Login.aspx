        ...
        <div class="login-form content">
            <form runat="server">
				...
				<div class="form-group">
					...
					<asp:TextBox id="txtUsername" runat="server" type="text" class="form-control" placeholder="Username" MaxLength="10"></asp:TextBox>
				...
				<div class="form-group">
					...
					<asp:TextBox ID="txtPassword" runat="server" type="password" class="form-control" placeholder="Password" MaxLength="100"></asp:TextBox>
