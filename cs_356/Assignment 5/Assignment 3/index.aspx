...
<body>
    <asp:SqlDataSource ID="SQLServerWebProjectDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:SQLServerWebProjectDB %>"></asp:SqlDataSource>
	...
	<div class="container mt-5">
		<asp:Label ID="lblInsertError" runat="server" Text="Error creating user!" class="display-4" ForeColor="Red" Visible="false"></asp:Label>
        <!--User creation form -->
		<form runat="server" class="needs-validation" novalidate>
			<div class="row">
				<div class="col">
					<div class="form-group">
						...
						<asp:TextBox ID="txtFirstName" runat="server" type="text" class="form-control" MaxLength="30" required></asp:TextBox>
				...
				<div class="col">
					<div class="form-group">
						...
						<asp:TextBox ID="txtLastName" runat="server" type="text" class="form-control" MaxLength="30" required></asp:TextBox>
			...
			<div class="row">
				<div class="col">
					<div class="form-group">
						...
						<asp:TextBox ID="txtUsername" runat="server" type="text" class="form-control" MaxLength="30" required></asp:TextBox>
                        <div class="invalid-feedback">A username is required!</div>
						<asp:Label ID="lblUsernameError" runat="server" Text="Username is already in use!" ForeColor="Red" Visible="false"></asp:Label>
					</div>
				</div>
				<div class="col">
					<div class="form-group">
						<asp:Label runat="server" class="bmd-label-floating" Text="Password"></asp:Label>
						<asp:TextBox ID="txtPassword" runat="server" type="password" class="form-control" MaxLength="20" required></asp:TextBox>
			...
			<div class="form-group">
				...
				<asp:TextBox ID="txtEmail" runat="server" type="email" class="form-control" MaxLength="100" required></asp:TextBox>
                <div class="invalid-feedback">Your email address is required!</div>
				<asp:Label ID="lblEmailErrror" runat="server" Text="Email Address is already in use!" ForeColor="Red" Visible="false"></asp:Label>
			</div>
			<div class="row">
				<div class="col">
					<div class="form-group">
						<asp:Label runat="server" class="bmd-label-floating" Text="Address"></asp:Label>
						<asp:TextBox ID="txtAddress" runat="server" type="text" class="form-control" MaxLength="100" required></asp:TextBox>
				...
				<div class="col">
					<div class="form-group">
						...
						<asp:TextBox ID="txtCity" runat="server" type="text" class="form-control" MaxLength="30" required></asp:TextBox>
            ...
            <div class="row">
				...
				<div class="col mt-2">
					<div class="form-group">
						...
						<asp:TextBox ID="txtZip" runat="server" type="number" class="form-control" MaxLength="10" required></asp:TextBox>
			...
			<div class="row">
				<div class="col mt-2">
					<div class="form-group">
						...
						<asp:TextBox ID="txtPhone" runat="server" type="number" class="form-control" MaxLength="12" required></asp:TextBox>
